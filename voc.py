...
def download_voc2007(root):
    ...
    if not os.path.exists(path_devkit):
        ...
        if not os.path.exists(cached_file):
            ...
            utils_file.download_url(urls['devkit'], cached_file)
    ...
    if not os.path.exists(path_images):
        ...
        if not os.path.exists(cached_file):
            ...
            utils_file.download_url(urls['trainval_2007'], cached_file)
    ...
    if not os.path.exists(test_anno):
        ...
        if not os.path.exists(cached_file):
            ...
            utils_file.download_url(urls['test_images_2007'], cached_file)
    ...
    if not os.path.exists(test_image):
        ...
        if not os.path.exists(cached_file):
            ...
            utils_file.download_url(urls['test_anno_2007'], cached_file)
...
class Voc2007Classification(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.ifknn:
            return img, target, index, self.knn[index]
...
def download_voc2012(root):
    ...
    if not os.path.exists(path_devkit):
        ...
        if not os.path.exists(cached_file):
            ...
            utils_file.download_url(urls2012['devkit'], cached_file)
    ...
    if not os.path.exists(path_images):
        ...
        if not os.path.exists(cached_file):
            ...
            utils_file.download_url(urls2012['trainval_2012'], cached_file)
    ...
    if not os.path.exists(test_anno):
        ...
        if 'test_images_2012' in urls:
            parts = urlparse(urls['test_images_2012'])
            filename = os.path.basename(parts.path)
            cached_file = os.path.join(root, filename)
            download_url(urls['test_images_2012'], cached_file)
            filename = os.path.basename(parts.path)
            cached_file = os.path.join(tmpdir, filename)

            if not os.path.exists(cached_file):
                print('Downloading: "{}" to {}\n'.format(urls['test_images_2012'], cached_file))
                utils_file.download_url(urls['test_images_2012'], cached_file)
        ...
        if not os.path.exists(test_image):
            ...
            if not os.path.exists(cached_file):
                ...
                utils_file.download_url(urls2012['test_images_2012'], cached_file)
