...
class PC_Dataset(Dataset):
    ...
    def _compute_category_counts(self, labels):
        # 私有方法，用于计算类别样本数量
        print(labels.shape) 
    ...
    def get_category_counts(self):
        ...
        if not hasattr(self, 'category_counts'):
            self.gt_category_counts = self._compute_category_counts(self.clean_gt)
            self.noisy_category_counts = self._compute_category_counts(self.gt)
        return self.gt_category_counts, self.noisy_category_counts
